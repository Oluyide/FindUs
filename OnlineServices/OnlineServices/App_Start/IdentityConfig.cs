...
namespace OnlineServices
{
    public class EmailService : IIdentityMessageService
    {
        ...
        public void SendEmail(IdentityMessage message)
        {
            ...
            myMessage.CC.Add(new MailAddress("ajibolabiodun@gmail.com"));
            myMessage.From = new MailAddress(ConfigurationManager.AppSettings["sender"]);  // replace with valid value
            ...
            using (var smtp = new SmtpClient())
            {
                ...
                {
                    UserName = ConfigurationManager.AppSettings["sender"],  // replace with valid value
                    Password = ConfigurationManager.AppSettings["password"]  // replace with valid value
                };
