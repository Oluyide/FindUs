...
namespace OnlineServices.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    TempData["UserName"] =  "Username:" + model.UserName;
                     TempData["Password"]= "Password:" + model.Password;
        ...
        {
            var userprofile = register.UserByIdentifier(User.Identity.GetUserId()).SingleOrDefault();
            ViewBag.CongratMessage = "Hello    " + userprofile.FirstName ;
            return View();
        }
        [AllowAnonymous]
        ...
        [HttpPost]
        public async Task<ActionResult> ConfirmEmail(ConfirmationModels model)
        {
            var userprofile = register.UserByIdentifier(Session["userId"].ToString());
            try
            {
                if (ModelState.IsValid && userprofile.SingleOrDefault().RegCode != null)
                {
                    if (userprofile.SingleOrDefault().RegCode == model.AdminCode.ToString())
                    {
                        Session["confirm"] = "Thank you for claiming your account";
                        //return View("Confirm");
                        return RedirectToAction("SuccessPage");
                    }
                    else
                    {
                        Session["wrongCode"] = "You have entered a wrong Approval Code";
                        return View("Error");
                    }
                ...
                {
                    Session["ApprovalCode"] = "ApprovalCode Cannot be empty";
                    return View("Error");
                }
            }
            catch
